...
from roberta_model import Seq2Seq
...
def test(args, model, tokenizer, test_dataset, best_threshold=0.5):
    ...
    for batch in bar:
        ...
        with torch.no_grad():
            token_embeddings = model.encoder.embeddings.word_embeddings(input_ids)  # Get embeddings for input tokens
            logger.info("\n==== Token Embeddings ====")
