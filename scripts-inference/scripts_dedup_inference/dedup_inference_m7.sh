#!/bin/bash
#SBATCH --job-name=t7_inference_dedup         # Job name
#SBATCH --gres=gpu:1                   # Request 1 GPU
#SBATCH --mem=16G                      # Request 16GB of memory
#SBATCH --output=D_inf7.log      # Standard output file
#SBATCH --error=D_inf7.txt        # Standard error file
#SBATCH --time=10:00:00
#SBATCH --cpus-per-task=4
#SBATCH --mail-user=(add username here)
